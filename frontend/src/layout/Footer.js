    ...
    <div style={{ backgroundColor: "#fdd3e5"}} className='footer text-center text-white'>
      <Container className='p-5 pb-0'>
        <section className=' mb-4'>
          <Button outline color="light" floating className='btn-footer m-1' href='mailto:ulkar.isayeva@gmail.com' role='button'>
             <MdEmail/>
          </Button>

          <Button outline color="light" floating className='btn-footer m-1' href='tel:000000000000' role='button'>
         <AiFillPhone />
          </Button>
